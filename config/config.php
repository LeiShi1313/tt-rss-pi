<?php
	...
	define('DB_HOST', "database.postgres");
	...
	define('SELF_URL_PATH', 'http://localhost:8040/');
	...
	define('REG_NOTIFY_ADDRESS', 'ttrss@leishi.io');
	...
	define('SMTP_FROM_ADDRESS', 'ttrss@leishi.io');
